...
$('.cardlorem1').click(function (e) { 
 ...
 //POUR IMPLEMENTER LE POIDS(SES INPUT DANS LE HTML)-
...
// FONCTION POUR LA COULEUR DU TEXTE DES INPUTS


$(document).ready(function () { 

$('#exampleColorInput').on("input change", function (){
...
// POUR IMPLEMENTER LA COULEUR DU TEXTE AVEC JAVASCRIPT
